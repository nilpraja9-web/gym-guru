...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        "bg-[var(--color-accent)] text-black hover:bg-[var(--color-accent-hover)] hover:shadow-[0_0_20px_rgba(163,230,53,0.4)] hover:-translate-y-0.5 active:translate-y-0",
      secondary:
        "bg-[var(--color-card)] text-[var(--color-foreground)] border border-[var(--color-border)] hover:bg-[var(--color-border)] hover:-translate-y-0.5 active:translate-y-0",
      ghost:
